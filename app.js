...
async function resourceList(){
  ...
  return ['/','/index.html','/style.css','/app.js','/service-worker.js','/socket.io/socket.io.js','/assets/reference-arena.jpg','/assets/reference-cards.jpg','/assets/reference-lobby.jpg','/assets/audio/uno50-theme.wav',...refs.maps.map(m=>'/'+m.resource),...Array.from({length:100},(_,i)=>`/assets/cosmetics/cosmetic_${String(i+1).padStart(3,'0')}.svg`)];
}
